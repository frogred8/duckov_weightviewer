// Code copied from GitHub: https://github.com/FrozenFish259/duckov_mod_config
...
public static class ModConfigAPI
{
    ...
    public static bool Initialize()
    {
        try
        {
            ...
            {
                Debug.LogWarning($"[{TAG}] ModConfig.ModBehaviour is not loaded");
                return false;
            }
            ...
            {
                Debug.LogWarning($"[{TAG}] ModConfig.OptionsManager_Mod not found type");
                return false;
            }
            ...
            isInitialized = true;
            Debug.Log($"[{TAG}] ModConfigAPI loaded");
            return true;
        }
        catch (Exception ex)
        {
